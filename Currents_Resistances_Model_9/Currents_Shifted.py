...
current_data['ex_current'] = ox_eq**2 * hole_eq**3 * fe_eq**-3 * vac_eq**-1 * \
                             1/(1+7.344e9*current_data['pressure']*fe_eq/hole_eq)

# Calculate net currents
current_data['current'] = current_data['ex_current'] * \
                          ((1+7.344e9*current_data['pressure']*fe_eq/hole_eq)/(1+7.344e9*current_data['pressure']*fe/hole))\
...
save('Current_Data_Model_9_Shifted.npy', current_data)
