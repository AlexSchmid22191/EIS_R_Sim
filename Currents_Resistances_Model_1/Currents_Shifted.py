...
current_data['ex_current'] = hole_eq**4 * ox_eq**2

# Calculate net currents
current_data['current'] = current_data['ex_current']*((hole/hole_eq)**4*(ox/ox_eq)**2 - (vac/vac_eq)**2*(fe/fe_eq)**4)
...
save('Current_Data_Model_1_Shifted.npy', current_data)
