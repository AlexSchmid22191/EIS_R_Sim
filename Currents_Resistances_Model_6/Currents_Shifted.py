...
current_data['ex_current'] = ox_eq**2 * hole_eq**2 / fe_eq**2

# Calculate net currents
current_data['current'] = current_data['ex_current'] * \
                          ((ox/ox_eq)**2*(hole/hole_eq)**2*(fe/fe_eq)**-2
                           - (vac/vac_eq)**2*(hole/hole_eq)**-2*(fe/fe_eq)**2)
...
save('Current_Data_Model_6_Shifted.npy', current_data)
