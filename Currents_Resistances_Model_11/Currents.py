...
save('Current_Data_Model_11.npy', current_data)
savetxt('../CSVs/Current_Data_Model_11.csv', current_data.flatten(), header=','.join(name for name in datatype.names), fmt='%5.4e')
