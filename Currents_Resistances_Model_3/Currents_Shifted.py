...
current_data['ex_current'] = ox_eq * hole_eq / fe_eq

# Calculate net currents
current_data['current'] = current_data['ex_current']*\
                          ((ox/ox_eq)*(hole/hole_eq)*(fe/fe_eq)**-1 - (vac/vac_eq)*(fe/fe_eq)*(hole/hole_eq)**-1)
...
save('Current_Data_Model_3_Shifted.npy', current_data)
