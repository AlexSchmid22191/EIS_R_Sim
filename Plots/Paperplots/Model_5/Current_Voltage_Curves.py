...
semilog_slope(origin=(-0.3, 1e-4), slope=-4*e/k/T, ax=ax_abs_uh, text=r'$\frac{4e}{kT}$', size=12, inverted=True)
...
ax_abs_uh.set_ylim(1e-9, 1e3)
ax_abs_hi.set_ylim(1e-4, 1e3)
...
fig_abs_uh.savefig('Plots/Current_Voltage_Curves_Abs_Uh_Model_5.pdf')
fig_abs_uh.savefig('Plots/Current_Voltage_Curves_Abs_Uh_Model_5.png')

fig_abs_hi.tight_layout()
fig_abs_hi.savefig('Plots/Current_Voltage_Curves_Abs_Hi_Model_5.pdf')
fig_abs_hi.savefig('Plots/Current_Voltage_Curves_Abs_Hi_Model_5.png')

fig_abs_me.tight_layout()
fig_abs_me.savefig('Plots/Current_Voltage_Curves_Abs_Me_Model_5.pdf')
fig_abs_me.savefig('Plots/Current_Voltage_Curves_Abs_Me_Model_5.png')

fig_abs_lo.tight_layout()
fig_abs_lo.savefig('Plots/Current_Voltage_Curves_Abs_Lo_Model_5.pdf')
fig_abs_lo.savefig('Plots/Current_Voltage_Curves_Abs_Lo_Model_5.png')
