...
semilog_slope(origin=(0.25, 1e6), slope=2*e/k/T, ax=ax_abs_uh, text=r'$\frac{2e}{kT}$', size=18, inverted=True)

ax_abs_hi.text(-0.475, 2e4, '0')
ax_abs_hi.add_patch(Rectangle((-0.6, 5e3), 0.25, 5e3, linewidth=0, facecolor='0.8'))
semilog_slope(origin=(-0.3, 2e1), slope=-1*e/k/T, ax=ax_abs_hi, text=r'$-\frac{e}{kT}$', size=18, inverted=True)
semilog_slope(origin=(0.4, 1e3), slope=2*e/k/T, ax=ax_abs_hi, text=r'$\frac{2e}{kT}$', size=18, inverted=False)

semilog_slope(origin=(0.55, 4e2), slope=2*e/k/T, ax=ax_abs_me, text=r'$\frac{2e}{kT}$', size=18, inverted=False)
semilog_slope(origin=(0.2, 1e-2), slope=3*e/k/T, ax=ax_abs_me, text=r'$\frac{3e}{kT}$', size=18, inverted=False)
semilog_slope(origin=(-0.5, 1e-1), slope=-1*e/k/T, ax=ax_abs_me, text=r'$-\frac{e}{kT}$', size=18, inverted=True)
...
semilog_slope(origin=(-0.3, 1e-6), slope=-1*e/k/T, ax=ax_abs_lo, text=r'$-\frac{e}{kT}$', size=18, inverted=True)
...
ax_abs_me.legend(loc=(0.7125, 0.0))
