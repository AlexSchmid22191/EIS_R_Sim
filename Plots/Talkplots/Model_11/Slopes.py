...
data = load('../../../Currents_Resistances_Model_11/Slope_Data_Model_11.npy')
...
colmesh_p = p_ax.pcolormesh(data['pressure'], data['overpotential'], data['p_slope'], vmin=-0.5, vmax=0.5)
...
colmesh_n = n_ax.pcolormesh(data['pressure'], data['overpotential'], data['n_slope']*k*T/e, vmin=-2, vmax=2)
