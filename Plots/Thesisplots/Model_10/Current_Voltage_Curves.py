...
from matplotlib.ticker import LogLocator, NullFormatter, MultipleLocator, LinearLocator
...
ax_abs_uh.set_ylim(1e-1, 1e5)
ax_abs_hi.set_ylim(1e-1, 1e3)
ax_abs_me.set_ylim(1e-3, 1e1)
...
ax_abs_uh.yaxis.set_major_locator(LogLocator(numticks=9))
ax_abs_uh.yaxis.set_minor_locator(LogLocator(numticks=9, subs=range(1, 10)))
