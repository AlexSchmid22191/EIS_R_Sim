...
fig_an.tight_layout()
fig_an.savefig('Plots/jp_Curves_An_Model_11.pdf')
fig_an.savefig('Plots/jp_Curves_An_Model_11.png')

fig_cat.tight_layout()
fig_cat.savefig('Plots/jp_Curves_Cat_Model_11.pdf')
fig_cat.savefig('Plots/jp_Curves_Cat_Model_11.png')
